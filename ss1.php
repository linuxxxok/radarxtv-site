...
<div class="player-container">
    <div style="padding:56.25% 0 0 0;position:relative;">
        <iframe id="contentFrame" sandbox="allow-forms allow-pointer-lock allow-same-origin allow-scripts allow-top-navigation" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen="true" scrolling="no" src="https://vod.mafiatv.live/player.php?id=9c5fe1c5b3c0c1d5f3d1533f04e23db61b298640630e5ae67e2aa6cece3fe521a0fad832b1a45f8043b3d1f8454007309f07823dfe5db61c6d5e2cd106303908" style="position:absolute;top:0;left:0;width:100%;height:100%;"></iframe>
    </div>
</div>
<!-- Join Telegram Button -->
<div class="join-telegram-container">
    <button class="join-telegram-btn" onclick="window.open('https://t.me/+tL4jz_00y6NlMGRl', '_blank')">Join Telegram Channel</button>
</div>
 ...
 // Close popup function
  ...
  <div id="popup" style="display: none;">
    <div class="popup-content">
      ...
      <button class="join-btn" onclick="window.open('https://t.me/+tL4jz_00y6NlMGRl', '_blank')">Join Now</button>
...
<script>
        ...
        if (confirm("Join Our Telegram Channel @Cricinsider365")) {
            ...
            window.location.href = "https://t.me/+tL4jz_00y6NlMGRl";
        } else {
