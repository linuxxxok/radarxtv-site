...
<div class="ticker-container">
    <div class="ticker">
        📢 CT LIVE ON EVERY STREAM 📢
    </div>
</div>

<div class="stream-container">
    <a href="sky" class="stream-box">
        <img src="don/kk.jpg" alt="Stream 2">
        <div class="stream-title">sky live</div>
    </a>
    <a href="astro" class="stream-box">
        <img src="don/stream3.jpg" alt="Stream 3">
        <div class="stream-title">astro live</div>
    </a>
    <a href="willow" class="stream-box">
        <img src="don/stream1.jpg" alt="Stream 4">
        <div class="stream-title">willow live</div>
    </a>
    <a href="skynz" class="stream-box">
        <img src="don/kk.jpg" alt="Stream 5">
        <div class="stream-title">sky1 nz live</div>
    </a>
        <a href="fox" class="stream-box">
        <img src="don/stream4.jpg" alt="Stream 1">
        <div class="stream-title">PTV live</div>
    </a>
        <a href="starhindi" class="stream-box">
        <img src="don/kk.jpg" alt="Stream 6">
        <div class="stream-title">sports 18hd live</div>
    </a>
