...
<?php include 'banner.php'; ?>
    <div class="stream-container">
      ...
      <a href="prime" class="stream-card" style="border-color: #00FFD1;">
           ...
           <a href="HINDIJIOSTAR" class="stream-card" style="border-color: #00FFD1;">
            <img src="don/stream1.jpg" alt="SKY MAINEVENT 2">
            <div class="card-content">
                <h3>PRIME HINDI LIVE </h3>
        ...
        <a href="astro" class="stream-card" style="border-color: #FF45A7;">
            <img src="don/stream3.jpg" alt="SKY CRICKET 2">
            <div class="card-content">
                <h3>ASTRO LIVE</h3>
                <p>Watch astrolive stream here.</p>
            </div>
        </a>
        <a href="skymain" class="stream-card" style="border-color: #00FFD1;">
            <img src="don/stream2.jpg" alt="SKY MAINEVENT 2">
            <div class="card-content">
                <h3>SKY NZ 1 </h3>
                <p>Watch Sky nz 1 live stream here.</p>
            </div>
        </a>
           <a href="sky22/tenhd.php" class="stream-card" style="border-color: #00FFD1;">
            <img src="don/stream1.jpg" alt="SKY MAINEVENT 2">
            <div class="card-content">
                <h3>TEN SPORTS HD </h3>
