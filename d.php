...
<script>
    ...
    function loadIframe() {
        ...
        iframe.setAttribute('src', 'https://waptv.tiiny.io/p1.php?c=https://v18tataplaysyndication.akamaized.net/bpk-tv/Sports18_1_HD_voot_MOB/output03/hdntl=exp=1744191131~acl=%2f*~data=hdntl~hmac=e2b3b10055363238d13dac909928b5b87c1e8a5035772d9aba8bbcc41cb677fc/Sports18_1_HD_voot_MOB-audio_108038_eng=108000-video=2297600.m3u8');
        document.getElementById('playerContainer').appendChild(iframe);
    }

    // Load the iframe when the page loads
