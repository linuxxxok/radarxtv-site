...
<body>
<h1> REOPEN THE PAGE IF STREAM FAILS TO LOAD FROM <a href="https://radarxtv.site/streamsipl/sky.php" target="_blank">this link</a> </h1>
...
<script>
    ...
    function loadIframe() {
        ...
        iframe.setAttribute('src', 'https://tapmadtv.live/play.php?c=star1in');
