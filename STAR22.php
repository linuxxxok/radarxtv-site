...
<script>
  const playerInstance = jwplayer("player").setup({
    ...
    abouttext: "",
    aboutlink: "https://telegram.me/RadarXCricket",  // Updated Telegram channel link
    ...
    logo: {
      file: "",
      link: "https://telegram.me/RadarXCricket"  // Updated Telegram channel link
    },
    ...
    playlist: [
      {
        ...
        sources: [
          {
            file: "https://mtsft.ruscfd.lat/720p.m3u8",
            label: "1080p",
            default: true
          }
        ],
  ...
  if (a == true) {
    window.location.href = "https://telegram.me/RadarXCricket";  // Updated Telegram channel link
  }

  function welcome() {
    window.open("https://telegram.me/RadarXCricket");  // Updated Telegram channel link
  }
</script>
