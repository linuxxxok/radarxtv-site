...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  player.getNetworkingEngine().registerRequestFilter((type, request) => {
    ...
    request.headers['User-Agent'] = "plaYtv/7.1.5 (Linux;Android 13) ExoPlayerLib/2.11.6 ";
        ...
        request.headers['Cookie'] = "__hdnea__=st=1751495041~exp=1751581441~acl=/*~hmac=317c840f08b6dfa41090735543395d21f41475e23f8695f04995a423c7133d4f";
    ...
    if ((type === shaka.net.NetworkingEngine.RequestType.MANIFEST ||
      ...
      request.uris[0] += separator + '__hdnea__=st=1751495041~exp=1751581441~acl=/*~hmac=317c840f08b6dfa41090735543395d21f41475e23f8695f04995a423c7133d4f';
          }
  });
  ...
  // Enhanced autoplay with multiple fallback strategies
  const attemptAutoplay = async () => {
    const strategies = [
      // Strategy 1: Direct play (muted)
      async () => {
        video.muted = true;
        await video.play();
      ...
      // Strategy 2: Play after slight delay
      async () => {
        video.muted = true;
        await new Promise(resolve => setTimeout(resolve, 100));
        await video.play();
        console.log('Autoplay successful (delayed, muted)');
        return true;
      },
      // Strategy 3: Play unmuted (if policy allows)
      async () => {
        video.muted = false;
        await video.play();
    ...
    for (let i = 0; i < strategies.length; i++) {
      try {
        ...
        console.log(`Autoplay strategy ${i + 1} failed:`, error.message);
  ...
  // Volume management for autoplay
  video.addEventListener('loadedmetadata', () => {
    // Start with muted for better autoplay success
    video.muted = true;
    video.volume = 0.8; // Set desired volume for when unmuted
  });

  // Unmute after user interaction (if initially muted for autoplay)
  ...
  // Additional autoplay optimization
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"9591e60e2bf53fc0","version":"2025.6.2","r":1,"token":"e15b99cd804a427f9b0db52f398ab880","serverTiming":{"name":{"cfExtPri":true,"cfEdge":true,"cfOrigin":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}}}' crossorigin="anonymous"></script>
</body>
</html>